...
def calculate_weight(inputs, n_top=8, sigma=4):
    # n_top: truncation parameter. Points further than 8th nearest distance will not be considered
    # sigma: normalization parameter. the weight is normalized by the 4th nearest distance.
