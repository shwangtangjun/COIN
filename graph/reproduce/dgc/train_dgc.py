...
from utils_dgc import load_data, accuracy, get_best_params
from dgc import DGC, dgc_precompute
import copy
import time
...
def run_single_trial_of_single_split(adj, features, labels, idx_train, idx_val, idx_test, torch_seeds, opt):
    ...
    features, precompute_time = dgc_precompute(features, adj, opt['T'], opt['K'])
